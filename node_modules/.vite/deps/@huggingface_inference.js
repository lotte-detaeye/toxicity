...
var InferenceClientHttpRequestError = class extends InferenceClientError {
  constructor(message, httpRequest, httpResponse) {
    ...
    __publicField(this, "httpResponse");
    this.httpRequest = {
      ...httpRequest,
      ...httpRequest.headers ? {
        headers: {
...
var TaskProviderHelper = class {
  constructor(provider, baseUrl, clientSideRoutingOnly = false) {
    ...
    __publicField(this, "clientSideRoutingOnly");
...
var BaseConversationalTask = class extends TaskProviderHelper {
  ...
  async getResponse(response) {
    if (typeof response === "object" && Array.isArray(response == null ? void 0 : response.choices) && typeof (response == null ? void 0 : response.created) === "number" && typeof (response == null ? void 0 : response.id) === "string" && typeof (response == null ? void 0 : response.model) === "string" && /// Together.ai and Nebius do not output a system_fingerprint
    (response.system_fingerprint === void 0 || response.system_fingerprint === null || typeof response.system_fingerprint === "string") && typeof (response == null ? void 0 : response.usage) === "object") {
      return response;
    }
...
var HFInferenceTextGenerationTask = class extends HFInferenceTask {
  async getResponse(response) {
    const res = toArray(response);
    if (Array.isArray(res) && res.every((x) => "generated_text" in x && typeof (x == null ? void 0 : x.generated_text) === "string")) {
...
var HFInferenceDocumentQuestionAnsweringTask = class extends HFInferenceTask {
  async getResponse(response) {
    if (Array.isArray(response) && response.every((elem) => typeof elem === "object" && !!elem && typeof (elem == null ? void 0 : elem.answer) === "string" && (typeof elem.end === "number" || typeof elem.end === "undefined") && (typeof elem.score === "number" || typeof elem.score === "undefined") && (typeof elem.start === "number" || typeof elem.start === "undefined"))) {
      return response[0];
    }
...
var HFInferenceImageToTextTask = class extends HFInferenceTask {
  async getResponse(response) {
    if (typeof (response == null ? void 0 : response.generated_text) !== "string") {
...
var HFInferenceTextClassificationTask = class extends HFInferenceTask {
  async getResponse(response) {
    const output = response == null ? void 0 : response[0];
    if (Array.isArray(output) && output.every((x) => typeof (x == null ? void 0 : x.label) === "string" && typeof x.score === "number")) {
      return output;
    }
...
var HFInferenceTranslationTask = class extends HFInferenceTask {
  async getResponse(response) {
    if (Array.isArray(response) && response.every((x) => typeof (x == null ? void 0 : x.translation_text) === "string")) {
      return (response == null ? void 0 : response.length) === 1 ? response == null ? void 0 : response[0] : response;
    }
...
var HFInferenceSummarizationTask = class extends HFInferenceTask {
  async getResponse(response) {
    if (Array.isArray(response) && response.every((x) => typeof (x == null ? void 0 : x.summary_text) === "string")) {
      return response == null ? void 0 : response[0];
    }
...
var HFInferenceVisualQuestionAnsweringTask = class extends HFInferenceTask {
  async getResponse(response) {
    if (Array.isArray(response) && response.every((elem) => typeof elem === "object" && !!elem && typeof (elem == null ? void 0 : elem.answer) === "string" && typeof elem.score === "number")) {
      return response[0];
    }
...
async function fetchInferenceProviderMappingForModel(modelId, accessToken, options) {
  ...
  if (inferenceProviderMappingCache.has(modelId)) {
    ...
    const resp = await ((options == null ? void 0 : options.fetch) ?? fetch)(url, {
      headers: (accessToken == null ? void 0 : accessToken.startsWith("hf_")) ? { Authorization: `Bearer ${accessToken}` } : {}
    });
    if (!resp.ok) {
      if ((_a = resp.headers.get("Content-Type")) == null ? void 0 : _a.startsWith("application/json")) {
    ...
    if (!(payload == null ? void 0 : payload.inferenceProviderMapping)) {
...
async function resolveProvider(provider, modelId, endpointUrl) {
  ...
  if (provider === "auto") {
    ...
    provider = (_a = mappings[0]) == null ? void 0 : _a.provider;
...
var FalAITextToImageTask = class extends FalAITask {
  preparePayload(params) {
    ...
    if (((_a = params.mapping) == null ? void 0 : _a.adapter) === "lora" && params.mapping.adapterWeightsPath) {
      payload.loras = [
        {
...
var FalAIAutomaticSpeechRecognitionTask = class extends FalAITask {
  ...
  async getResponse(response) {
    const res = response;
    if (typeof (res == null ? void 0 : res.text) !== "string") {
...
var FalAITextToSpeechTask = class extends FalAITask {
  ...
  async getResponse(response) {
    var _a;
    const res = response;
    if (typeof ((_a = res == null ? void 0 : res.audio) == null ? void 0 : _a.url) !== "string") {
...
var FeatherlessAITextGenerationTask = class extends BaseTextGenerationTask {
  ...
  async getResponse(response) {
    if (typeof response === "object" && "choices" in response && Array.isArray(response == null ? void 0 : response.choices) && typeof (response == null ? void 0 : response.model) === "string") {
...
var NebiusConversationalTask = class extends BaseConversationalTask {
  ...
  preparePayload(params) {
    ...
    if ((responseFormat == null ? void 0 : responseFormat.type) === "json_schema" && ((_a = responseFormat.json_schema) == null ? void 0 : _a.schema)) {
...
var NebiusTextGenerationTask = class extends BaseTextGenerationTask {
  ...
  async getResponse(response) {
    var _a;
    if (typeof response === "object" && "choices" in response && Array.isArray(response == null ? void 0 : response.choices) && response.choices.length > 0 && typeof ((_a = response.choices[0]) == null ? void 0 : _a.text) === "string") {
      return {
  ...
  preparePayload(params) {
    ...
    return {
      input: {
        ...
        ...params.args.parameters,
        prompt: params.args.inputs,
        lora_weights: ((_a = params.mapping) == null ? void 0 : _a.adapter) === "lora" && params.mapping.adapterWeightsPath ? `https://huggingface.co/${params.mapping.hfModelId}` : void 0
      },
      version: params.model.includes(":") ? params.model.split(":")[1] : void 0
    };
  }
...
var ReplicateAutomaticSpeechRecognitionTask = class extends ReplicateTask {
  ...
  async getResponse(response) {
    if (typeof (response == null ? void 0 : response.output) === "string")
      return { text: response.output };
    if (Array.isArray(response == null ? void 0 : response.output) && typeof response.output[0] === "string")
      return { text: response.output[0] };
    const out = response == null ? void 0 : response.output;
...
var SambanovaConversationalTask = class extends BaseConversationalTask {
  ...
  preparePayload(params) {
    const responseFormat = params.args.response_format;
    if ((responseFormat == null ? void 0 : responseFormat.type) === "json_schema" && responseFormat.json_schema) {
...
var TogetherConversationalTask = class extends BaseConversationalTask {
  ...
  preparePayload(params) {
    ...
    if ((response_format == null ? void 0 : response_format.type) === "json_schema" && ((_a = response_format == null ? void 0 : response_format.json_schema) == null ? void 0 : _a.schema)) {
...
async function request(args, options) {
  ...
  const providerHelper = getProviderHelper(provider, options == null ? void 0 : options.task);
...
async function textToImage(args, options) {
  ...
  return providerHelper.getResponse(res, url, info.headers, options == null ? void 0 : options.outputType);
}
...
function parse(tokens) {
  ...
  function isStatement(...names) {
    var _a, _b, _c;
    return ((_a = tokens[current]) == null ? void 0 : _a.type) === TOKEN_TYPES.OpenStatement && ((_b = tokens[current + 1]) == null ? void 0 : _b.type) === TOKEN_TYPES.Identifier && names.includes((_c = tokens[current + 1]) == null ? void 0 : _c.value);
  }
...
var ArrayValue = class extends RuntimeValue {
  constructor() {
    ...
    __publicField(this, "builtins", /* @__PURE__ */ new Map([["length", new IntegerValue(this.value.length)]]));
  }
  /**
   * NOTE: necessary to override since all JavaScript arrays are considered truthy,
   * while only non-empty Python arrays are consider truthy.
...
var Template = class {
  ...
  format(options) {
    return format(this.parsed, (options == null ? void 0 : options.indent) || "	");
  }
};
...
function getData(type, partialTaskData = data_default18) {
  return {
    ...partialTaskData,
    id: type,
...
var TASKS_DATA = {
  ...
  "audio-to-audio": getData("audio-to-audio", data_default3),
  "audio-text-to-text": getData("audio-text-to-text", data_default18),
  "automatic-speech-recognition": getData("automatic-speech-recognition", data_default4),
  "depth-estimation": getData("depth-estimation", data_default17),
  "document-question-answering": getData("document-question-answering", data_default5),
  "visual-document-retrieval": getData("visual-document-retrieval", data_default36),
  ...
  "image-feature-extraction": getData("image-feature-extraction", data_default9),
  "image-segmentation": getData("image-segmentation", data_default13),
  "image-to-image": getData("image-to-image", data_default10),
  "image-text-to-text": getData("image-text-to-text", data_default12),
  "image-to-text": getData("image-to-text", data_default11),
  "image-to-video": getData("image-to-video", data_default14),
  "keypoint-detection": getData("keypoint-detection", data_default43),
  "mask-generation": getData("mask-generation", data_default15),
  "multiple-choice": void 0,
  "object-detection": getData("object-detection", data_default16),
  "video-classification": getData("video-classification", data_default35),
  other: void 0,
  "question-answering": getData("question-answering", data_default20),
  "reinforcement-learning": getData("reinforcement-learning", data_default19),
  robotics: void 0,
  "sentence-similarity": getData("sentence-similarity", data_default21),
  summarization: getData("summarization", data_default22),
  "table-question-answering": getData("table-question-answering", data_default23),
  "table-to-text": void 0,
  "tabular-classification": getData("tabular-classification", data_default24),
  "tabular-regression": getData("tabular-regression", data_default25),
  "tabular-to-text": void 0,
  "text-classification": getData("text-classification", data_default30),
  "text-generation": getData("text-generation", data_default31),
  "text-ranking": getData("text-ranking", data_default32),
  "text-retrieval": void 0,
  "text-to-image": getData("text-to-image", data_default26),
  "text-to-speech": getData("text-to-speech", data_default27),
  "text-to-audio": void 0,
  "text-to-video": getData("text-to-video", data_default33),
  "time-series-forecasting": void 0,
  "token-classification": getData("token-classification", data_default28),
  translation: getData("translation", data_default29),
  "unconditional-image-generation": getData("unconditional-image-generation", data_default34),
  "video-text-to-text": getData("video-text-to-text", data_default44),
  "video-to-video": getData("video-to-video", data_default18),
  "visual-question-answering": getData("visual-question-answering", data_default37),
  "voice-activity-detection": void 0,
  "zero-shot-classification": getData("zero-shot-classification", data_default38),
  "zero-shot-image-classification": getData("zero-shot-image-classification", data_default39),
  "zero-shot-object-detection": getData("zero-shot-object-detection", data_default40),
  "text-to-3d": getData("text-to-3d", data_default42),
  "image-to-3d": getData("image-to-3d", data_default41)
};
...
function get_widget_examples_from_st_model(model) {
  ...
  if ((widgetExample == null ? void 0 : widgetExample.source_sentence) && ((_b = widgetExample == null ? void 0 : widgetExample.sentences) == null ? void 0 : _b.length)) {
...
var hasChatTemplate = (model) => {
  var _a, _b, _c, _d, _e;
  return ((_b = (_a = model.config) == null ? void 0 : _a.tokenizer_config) == null ? void 0 : _b.chat_template) !== void 0 || ((_d = (_c = model.config) == null ? void 0 : _c.processor_config) == null ? void 0 : _d.chat_template) !== void 0 || ((_e = model.config) == null ? void 0 : _e.chat_template_jinja) !== void 0;
};
...
var pruna_transformers = (model) => {
  ...
  if (info == null ? void 0 : info.auto_model) {
...
var snippetGenerator = (templateName, inputPreparationFn) => {
  return (model, provider, inferenceProviderMapping, opts) => {
    var _a;
    const logger = getLogger();
    const providerModelId = (inferenceProviderMapping == null ? void 0 : inferenceProviderMapping.providerId) ?? model.id;
    ...
    const placeholder = (opts == null ? void 0 : opts.directRequest) ? ACCESS_TOKEN_DIRECT_REQUEST_PLACEHOLDER : ACCESS_TOKEN_ROUTING_PLACEHOLDER;
    const accessTokenOrPlaceholder = (opts == null ? void 0 : opts.accessToken) ?? placeholder;
    const inputs = (opts == null ? void 0 : opts.inputs) ? { inputs: opts.inputs } : inputPreparationFn ? inputPreparationFn(model, opts) : { inputs: getModelInputSnippet(model) };
    const request2 = makeRequestOptionsFromResolvedModel(providerModelId, providerHelper, {
      accessToken: accessTokenOrPlaceholder,
      provider,
      endpointUrl: (opts == null ? void 0 : opts.endpointUrl) ?? (provider === "auto" ? HF_ROUTER_AUTO_ENDPOINT : void 0),
      ...inputs
    }, inferenceProviderMapping, {
      task,
      billTo: opts == null ? void 0 : opts.billTo
    });
    ...
    const autoInputs = !(opts == null ? void 0 : opts.endpointUrl) && !(opts == null ? void 0 : opts.directRequest) ? provider !== "auto" ? {
      ...inputs,
    ...
    const params = {
      ...
      baseUrl: task === "conversational" && !(opts == null ? void 0 : opts.endpointUrl) && !(opts == null ? void 0 : opts.directRequest) ? HF_ROUTER_AUTO_ENDPOINT : removeSuffix(request2.url, "/chat/completions"),
      fullUrl: task === "conversational" && !(opts == null ? void 0 : opts.endpointUrl) && !(opts == null ? void 0 : opts.directRequest) ? HF_ROUTER_AUTO_ENDPOINT + "/chat/completions" : request2.url,
      inputs: {
        asObj: inputs,
      ...
      model,
      provider,
      providerModelId: task === "conversational" && !(opts == null ? void 0 : opts.endpointUrl) && !(opts == null ? void 0 : opts.directRequest) ? provider !== "auto" ? `${model.id}:${provider}` : model.id : providerModelId ?? model.id,
      billTo: opts == null ? void 0 : opts.billTo,
      endpointUrl: opts == null ? void 0 : opts.endpointUrl
    };
...
${snippet}`;
        ...
        if (snippet.includes(placeholder)) {
          snippet = replaceAccessTokenPlaceholder(opts == null ? void 0 : opts.directRequest, placeholder, snippet, language, provider, opts == null ? void 0 : opts.endpointUrl);
        }
...
var prepareConversationalInput = (model, opts) => {
  return {
    ...
    ...(opts == null ? void 0 : opts.max_tokens) ? { max_tokens: opts == null ? void 0 : opts.max_tokens } : void 0,
...
function getInferenceSnippets(model, provider, inferenceProviderMapping, opts) {
  var _a;
  return model.pipeline_tag && model.pipeline_tag in snippets ? ((_a = snippets[model.pipeline_tag]) == null ? void 0 : _a.call(snippets, model, provider, inferenceProviderMapping, opts)) ?? [] : [];
}
